...
import { Stack, TextField, FormControl, Select,MenuItem, InputLabel, Grid, Typography, ImageList, ImageListItem, IconButton, Modal, Button, Box, Divider } from "@mui/material";
            ...
            <ImageList sx={{ width: 500, height: 350 }} cols={3} rowHeight={164}>
                {eventData.images_urls.map((item, idx) => (
                    <ImageListItem key={item.url}>
                        ...
                        {item.default ? (
                            <div>
                                <Typography variant="h5" style={{ textAlign: "center", position: 'absolute', top: "25%" }}>
